...
\begin{tabular}{|l|l|l|}
\hline
\textbf{Token} & \textbf{Hex Value} & \textbf{Usage} \\
\hline
Primary Background & \#0A1929 & Main app background (navy blue) \\
\hline
Secondary Background & \#132F4C & Sidebar, cards, elevated surfaces \\
\hline
Border Color & \#1E4976 & Dividers, borders \\
\hline
Primary Text & \#FFFFFF & Main text, headings \\
\hline
Secondary Text & \#B2BAC2 & Timestamps, metadata, placeholders \\
\hline
Accent Blue & \#3399FF & Buttons, links, active states \\
\hline
Success Green & \#00C853 & Success messages, confirmations \\
\hline
Error Red & \#FF5252 & Error states, warnings \\
\hline
\end{tabular}
\end{table}
...
#### Typography
\begin{itemize}
\item \textbf{Font Family:} FK Grotesk (include WOFF2 files in app bundle)
\item \textbf{Heading 1:} 24px, weight 600, color Primary Text
\item \textbf{Heading 2:} 18px, weight 600, color Primary Text
\item \textbf{Body:} 14px, weight 400, color Primary Text
\item \textbf{Small:} 12px, weight 400, color Secondary Text
\item \textbf{Line Height:} 1.5 for body text, 1.2 for headings
\end{itemize}
...
#### Main Window
\begin{itemize}
\item \textbf{Dimensions:} 1200px width × 800px height (resizable, minimum 1000×600)
\item \textbf{Layout:} Fixed two-column layout
\item \textbf{Left Sidebar:} 400px width (1/3 of total)
\item \textbf{Right Chat Area:} 800px width (2/3 of total)
\item \textbf{No Gradients:} All colors are solid, no gradients anywhere in design
\end{itemize}
...
#### Structure
┌─────────────────────────────────────┐
│  [+ New Chat]             [Search]  │ ← Header (56px height)
├─────────────────────────────────────┤
│                                     │
│  ┌─────────────────────────────┐   │
│  │ Chat Title 1                │   │ ← Chat Item (64px height)
...
#### Header Section
\begin{itemize}
\item \textbf{New Chat Button:} Navy button (\#132F4C) with white text, "+ New Chat"
\item \textbf{Search Icon:} Right-aligned, opens search overlay when clicked
\item \textbf{Background:} Primary Background (\#0A1929)
\item \textbf{Padding:} 16px
\end{itemize}

#### Chat List Items
\begin{itemize}
\item \textbf{Background:} Secondary Background (\#132F4C) when hovered, transparent default
\item \textbf{Active State:} Accent Blue left border (4px), slightly lighter background
\item \textbf{Chat Title:} Body typography, Primary Text color, truncate at 1 line
\item \textbf{Preview Text:} Small typography, Secondary Text color, truncate at 1 line
\item \textbf{Timestamp:} Small typography, Secondary Text color, right-aligned
\item \textbf{Padding:} 12px
\item \textbf{Border Bottom:} 1px solid Border Color (\#1E4976)
\end{itemize}
...
#### Structure
┌───────────────────────────────────────────────────────┐
│  Mac Assistant        [Connectors] [Settings]         │ ← Header (56px)
├───────────────────────────────────────────────────────┤
│                                                       │
│  ┌─────────────────────────────────────────────┐     │
│  │ User: Can you check my emails?              │     │ ← User Message
│  └─────────────────────────────────────────────┘     │
│                                                       │
│  ┌─────────────────────────────────────────────┐     │
│  │ Assistant: I found 3 new emails...          │     │ ← Assistant Message
│  └─────────────────────────────────────────────┘     │
│                                                       │
│  (scrollable message history)                         │
│                                                       │
├───────────────────────────────────────────────────────┤
│  [Type your message here...]           [Send]        │ ← Input (64px)
└───────────────────────────────────────────────────────┘

#### Header Section
\begin{itemize}
\item \textbf{Title:} "Mac Assistant" in Heading 2 typography, left-aligned
\item \textbf{Connectors Button:} Text button with icon, opens connector modal
\item \textbf{Settings Button:} Text button with icon, opens settings modal
\item \textbf{Background:} Primary Background (\#0A1929)
\item \textbf{Border Bottom:} 1px solid Border Color (\#1E4976)
\item \textbf{Padding:} 16px
\end{itemize}
...
\begin{itemize}
\item \textbf{Background:} Primary Background (\#0A1929)
\item \textbf{Padding:} 24px
\item \textbf{Scroll:} Auto-scroll to bottom on new messages
\end{itemize}

#### User Message Bubble
\begin{itemize}
\item \textbf{Alignment:} Right-aligned
\item \textbf{Max Width:} 70\% of chat area
\item \textbf{Background:} Accent Blue (\#3399FF)
\item \textbf{Text Color:} White
\item \textbf{Border Radius:} 12px
\item \textbf{Padding:} 12px 16px
\item \textbf{Margin Bottom:} 16px
\end{itemize}

#### Assistant Message Bubble
\begin{itemize}
\item \textbf{Alignment:} Left-aligned
\item \textbf{Max Width:} 70\% of chat area
\item \textbf{Background:} Secondary Background (\#132F4C)
\item \textbf{Text Color:} Primary Text (\#FFFFFF)
\item \textbf{Border Radius:} 12px
\item \textbf{Padding:} 12px 16px
\item \textbf{Margin Bottom:} 16px
\end{itemize}

#### Status Messages (Tool Execution)
\begin{itemize}
\item \textbf{Style:} Italic text, Secondary Text color
\item \textbf{Examples:} "Reading messages from John...", "Drafting email..."
\item \textbf{Alignment:} Left-aligned, no bubble
\item \textbf{Margin:} 8px bottom
\end{itemize}

#### Input Area
\begin{itemize}
\item \textbf{Input Field:} Full width text area (auto-expanding, max 4 lines)
\item \textbf{Background:} Secondary Background (\#132F4C)
\item \textbf{Border:} 1px solid Border Color (\#1E4976), focus state uses Accent Blue
\item \textbf{Border Radius:} 8px
\item \textbf{Padding:} 12px
\item \textbf{Text Color:} Primary Text (\#FFFFFF)
\item \textbf{Placeholder Color:} Secondary Text (\#B2BAC2)
\item \textbf{Send Button:} Accent Blue background, white text, 40px height, "Send" label
\item \textbf{Keyboard Shortcut:} Enter to send (Shift+Enter for new line)
\end{itemize}

### Connectors Modal

#### Trigger
Clicking "Connectors" button in top-right header

#### Layout
\begin{itemize}
\item \textbf{Modal Overlay:} Semi-transparent black (\#000000 at 60\% opacity)
\item \textbf{Modal Content:} 600px width, auto height, centered
\item \textbf{Background:} Secondary Background (\#132F4C)
\item \textbf{Border Radius:} 12px
\item \textbf{Padding:} 32px
\end{itemize}
